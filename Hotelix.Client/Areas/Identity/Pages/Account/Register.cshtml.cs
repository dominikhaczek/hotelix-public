...
namespace Hotelix.Client.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            IEmailSender emailSender, IClientRepository clientRepository)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //add client
                    await _clientRepository.AddClientAsync(new Models.Database.Client
                    {
                        UserId = user.Id,
                        Name = Input.Name,
