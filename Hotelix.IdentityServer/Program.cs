...
namespace Hotelix.IdentityServer
{
    public class Program
    {
        public static int Main(string[] args)
        {
            ...
            var seqUri = configuration["ApiConfigs:Seq:Uri"];
            ...
            try
            {
                ...
                var host = CreateHostBuilder(args, seqUri).Build();
        ...
        public static IHostBuilder CreateHostBuilder(string[] args, string seqUri) =>
